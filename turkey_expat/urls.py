...
from  app.views import home, Profile, UserFullProfile, login, CreateEvent, UpcomingEvents,SignUp, EventDetails, UnderConstruction, EventThanks, SignOut,AllUniversities
